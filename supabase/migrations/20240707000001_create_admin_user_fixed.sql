...
VALUES 
  ('00000000-0000-0000-0000-000000000000', 'admin@genbi.com', '$2a$10$Ht9QyYDgkLNvVvKPSWXRTuQJfP1ZGWVnJDQJMQMVMfQJNYJ3JK5Uu', now(), '{"provider":"email","providers":["email"]}', '{"full_name":"Admin User"}', now(), now(), 'authenticated', false)
